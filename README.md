...
> 声明：本程序完全开源免费，仅用于学习和交流使用，请勿用于其他用途，否则后果自负。
>
> 如果您使用本程序，即视为您同意上述条款。
...
推送邮箱中显示`打卡成功`，但记录中没有出现的Bug已经修复，具体见[this commit](https://github.com/easechen/htu_health_check_in/commit/09e72a2c0b2932242d7060141d1498ce2930d278)。
